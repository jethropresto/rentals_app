            ...
            <nav className="h-full flex flex-col bg-white border-r shadow-sm">
                <div className="p-4 flex items-center justify-between ">
                    ...
                    <Link to="/">
                        <FontanaLogo
                            className={`
                                overflow-hidden transition-all ${ expanded ? "h-9" : "w-0"}
                            `}
                            alt="Fontana Logo"
                        />
                    </Link>
                    ...
                    <button 
                        ...
                        className="p-2.5 rounded-lg bg-gray-50 hover:bg-gray-100"
                    >
                        {expanded ? <RiExpandLeftLine size={16}/> : <RiExpandRightLine size={16}/>}
                    </button>
                </div>
